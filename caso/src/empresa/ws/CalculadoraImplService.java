 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.empresa/", wsdlLocation = "http://localhost:4040/caso/sueldo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.empresa/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4040/caso/sueldo?wsdl");
     ...
     * 
     * @return
     *     returns CalculadoraDao
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraDao getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.empresa/", "CalculadoraImplPort"), CalculadoraDao.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraDao getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.empresa/", "CalculadoraImplPort"), CalculadoraDao.class, features);
    }
